## Capítulo 42: Las embarcaciones (II)

"¿Ya no se pueden usar? ¡" Muchas personas mostraron signos de decepción. ¿Los elegantes buques de guerra con armadura, las múltiples torres de cañones y los buques de carga con armadura simplemente desaparecieron así?
"¿Por qué deberían varar?", preguntó alguien, expresando su desacuerdo. "Una vez que un barco se varara, sería muy difícil volver a ponerlo a flote. Ahora no hay suficientes tripulantes para operarlo, lo que significa que no se puede usar temporalmente, pero eso no significa que no se pueda usar en el futuro, ¿verdad?".

"¿Simplemente usarla y luego convertirla en una posada? ¡Eso es un desperdicio! Nosotros, los viajeros temporales, no tenemos un buque de guerra invencible. ¿Cómo podríamos enfrentarnos a los piratas?"

"Con este barco, no importan Zheng Zhilong, Liu Xiang, los holandeses, los ingleses, todos son insignificantes".
...
A lo largo de estas bahías, existen innumerables puertos, grandes y pequeños. Sin embargo, la mayoría son pequeños puertos naturales donde solo atracan algunos barcos de pesca. Aunque la isla de Hainan fue un importante punto de escala para el comercio marítimo entre China y el extranjero durante la dinastía Ming, y muchos barcos mercantes se detenían aquí para refugiarse del viento y reabastecerse de agua, el comercio marítimo en sí mismo no estaba muy desarrollado, y se concentraba principalmente en el puerto de Shenying, en Qionshan. Las bahías dentro de Lingao conservan casi todas su aspecto original.
...
"En los puertos de Lingao, las condiciones hidrológicas más favorables se encuentran en la región de Hou Shui Wan. Dentro de la bahía, a ambos lados de la isla de Linchang, existen canales profundos con una profundidad de 10 metros que se extienden hacia el interior de la bahía. La zona de sombra de olas al sur de la isla es una zona de acumulación de lodo y arena, con una profundidad de agua de 7 a 8 metros. A lo largo de la costa se encuentran arrecifes de coral, que tienen una gran resistencia a la erosión. La fuente de lodo y arena dentro de la bahía es relativamente escasa, y el estado de erosión y sedimentación de la costa tiende a ser estable. Se puede decir que la región de Hou Shui Wan es el mejor puerto natural de aguas profundas de Lingao. Para los viajeros temporales, Hou Shui Wan tiene la isla de Linchang como una barrera portuaria natural. La construcción de baterías en ella puede defender eficazmente los ataques marítimos, lo cual es mucho mejor que pequeñas islas como Hongpai Yu."

¿Qué es la profesionalidad? ¡Esto es la profesionalidad! Ya sea una organización militar excelente o una organización de producción social altamente eficiente, la división del trabajo es fundamental: asignar personal especializado a cada puesto de trabajo es la base y el requisito previo. El Comité Ejecutivo comprendió profundamente esto. En la sala de reuniones, se respiraba un ambiente de respeto y admiración.

"Parece que las cosas en este mundo no se pueden dar por sentadas", exclamó Ma Qianzhu con pesar.

"¿Hemos elegido la base portuaria en la bahía de Hou Shui? Parece que las condiciones de este lugar son excelentes."

"No, no es posible", Wen Desi negó con la cabeza repetidamente. "Houshuiwan es un buen puerto, pero no es adecuado como base de desembarco: no hay agua".

La región de Houshuiban en Lingao no contaba con ríos naturales importantes en la antigüedad, y era una de las áreas más secas del condado. Los pueblos cercanos a esta región sufrieron durante mucho tiempo por la escasez de agua, hasta que, después de la liberación, se perforaron pozos profundos y se excavaron varios canales de riego, lo que resolvió el problema de la falta de agua en la zona.

La falta de agua dulce dificulta cualquier actividad. Además, este lugar está un poco lejos de la ciudad de Lingao y de la base principal de los viajeros temporales. La comunicación y el transporte no son muy convenientes.

"¿Y cuál es tu sugerencia?", preguntó con un tono que ahora mostraba respeto.

"¿Dónde se establecerá la base principal en el futuro?"

"Bai Ren Tan. Se encuentra en la región baja del río Wenlan."

"Si tuviera que elegir un lugar cercano, sería Bopugang", pensó Mengde. "Bopugang es, en realidad, la desembocadura del río Wenlan, y se clasifica como un puerto de desembocadura. Históricamente, ha sido un punto clave de entrada y salida entre la isla de Hainan y el continente, y también es un puerto natural protegido. La profundidad del canal central del puerto puede alcanzar entre 6 y 7 metros, pero hay numerosos bancos de arena dentro del puerto, lo que limita el espacio para el anclaje."

"¿Esta profundidad es suficiente para un buque de diez mil toneladas? Creo recordar que su calado es de unos 7 metros."

"Es correcto, si fuera un buque de carga costero de aguas poco profundas, podría entrar aún más. El problema es que no tengo datos hidrológicos locales, bueno, más bien, no tengo datos hidrológicos de la dinastía Ming. Además, no tengo un guía de navegación, y aunque el personal de la maquinaria se pueda arreglar, incluso un puerto moderno no se puede atracar con esta embarcación. De hecho, muchas naves modernas, al entrar en puerto y atracar en el muelle, son 'empujadas' para llegar a la orilla. Con mi nivel de manejo de embarcaciones, si esta nave entra en el puerto y no se queda varada, sería pura suerte."

"El barco debe costar al menos varios millones. ¿Para qué gastar varios millones en construir un gran hotel, como el 'Daiwa'?"

"En realidad, mi sugerencia es usar una barcaza. Pueden ser barcazas de cubierta plana o de boca abierta", propuso Meng De, ofreciendo una sugerencia completamente poco llamativa y que fue universalmente despreciada por todos. Sin embargo, él no se inmutó. Al menos, en su campo de especialización, aún no había encontrado a nadie que fuera un experto, lo que le daba mucha confianza: al menos, no se exponía a ser severamente reprendido por decir algo incorrecto.

"¿Se está utilizando un remolcador? ¿No es eso algo que se usa en ríos?"

"Me refiero a las embarcaciones de transporte marítimo, que generalmente se utilizan en las zonas costeras y tienen una capacidad de carga que oscila entre 1500 y 8500 toneladas. Algunas de estas embarcaciones tienen motores y pueden realizar viajes cortos a lo largo de la costa. Estas embarcaciones tienen una calada muy baja; una embarcación de 1500 toneladas tiene una calada de apenas 2 metros."
...
"Tengo una idea", dijo Zhao De, del departamento de deportes. Debido a que anteriormente sirvió en la unidad de policía acuática y forma parte del futuro cuerpo de marines de los "viajeros temporales", también participó en esta reunión de selección de barcos.
...
"¡Todavía podemos pescar!"

"Sí, también se pueden usar para pescar. Este tipo de barco, generalmente un arrastrero, es muy resistente y duradero."

"Las embarcaciones pesqueras no son una buena compra", se opuso Mengde. "Los trámites administrativos son demasiado complicados."
