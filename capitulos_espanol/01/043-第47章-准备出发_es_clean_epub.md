...
Además del personal de navegación que permaneció en la agencia de transporte marítimo en la península de Leizhou, todos los viajeros temporales asignados a otras ubicaciones regresaron a la base para comenzar los preparativos finales.

El grupo de medicina y salud realizó una última revisión de la salud e higiene de los viajeros temporales, prestando especial atención a la inmunización. A pesar de las múltiples notificaciones, se descubrió que algunas personas no se habían vacunado, pero afirmaban falsamente haberlo hecho, e incluso algunas personas presentaron certificados de vacunación falsificados.

Para ciertas vacunas, ya es demasiado tarde para la revacunación; el proceso completo de la vacuna contra la hepatitis B dura un año y medio. El equipo de salud solo pudo aumentar la cantidad de vacunas adquiridas.

"¿Acaso esta gente no sabe que está jugando con sus propias vidas?", pensó Hé Mǎ mientras observaba los "informes de estado de vacunación incompletos" que habían sido recopilados. Aunque no sabía cómo era la situación de las enfermedades en Hainan en el siglo XVII, estaba seguro de que era un paraíso para todo tipo de microorganismos, y el cólera había estallado varias veces en Hainan incluso en el siglo XX.
...
10 tanques de oxígeno.

10 equipos de respiración.
...
20 juegos de instrumentos quirúrgicos.
...
Incluye un autoclave, diversos instrumentos médicos de acero inoxidable, un carro de desinfección con luz ultravioleta, un refrigerador, una incubadora para bebés, y mucho más.

El botiquín de primeros auxilios, configurado con 5 unidades por persona, donde 1 unidad se entrega directamente a cada individuo como equipo estándar.

"A menos que no hubiera otra opción para comprar, el Comité Ejecutivo había planeado adquirir un hospital de campaña completo, pero después de buscar en muchos lugares, no se encontró nada disponible, así que tuvimos que renunciar a la idea. La insistencia del Comité Ejecutivo en tener una solución completa para los problemas médicos estaba causando frustración entre los médicos del departamento de salud, quienes se vieron obligados a detener sus crecientes demandas. Incluso las máquinas de tomografía computarizada (TC) estaban en la lista de compras, y tuvieron que explicar que, aunque eran útiles, no eran indispensables..."

En cuanto al equipo personal de los "viajeros temporales", este refleja el principio del Comité Ejecutivo de "mejor tener de más que de menos". Sin embargo, el equipo se distribuyó en varios niveles según la división de tareas de cada persona.

Los viajeros temporales tienen una configuración personal de nivel A, que es el nivel estándar y es esencial para todos.

En este nivel, la configuración de los "viajeros temporales" está principalmente diseñada para satisfacer las necesidades diarias de producción y vida, al tiempo que ofrece protección contra conflictos de bajo nivel y capacidad para viajes todoterreno de corta distancia.
...
El equipo de comunicación consiste en un walkie-talkie y un silbato de emergencia. El walkie-talkie tiene un alcance de comunicación de más de 1 kilómetro y permite la creación de redes.

**Distribución de artículos personales:**

* Reloj deportivo resistente al agua (con funciones de medición de altitud, temperatura, presión atmosférica, brújula electrónica, cronómetro y alarma).
* Una navaja suiza "imitación" y un cuchillo corto.

## La brújula

(Texto en chino mandarín a traducir aquí)

**Faros**

**Linterna (que genera electricidad por fricción, lo que permite ahorrar baterías)**

encendedor a prueba de viento

* Pequeño vaso de acero (se puede usar para beber cualquier cosa, y por la mañana también puede servir como vaso para lavarse).

**Botella de agua para exteriores (con una buena resistencia a la corrosión y un diseño atractivo).**

* Cantimplora militar (viene con una caja para comida, lo cual es bastante práctico).

* Una caja de comida, un plato de porcelana y un juego de cubiertos de viaje.

Finalmente, cada persona también tenía provisiones de emergencia para dos días: barras energéticas y carne seca. Además, había un kit de costura y un botiquín de primeros auxilios.

En cuanto a los artículos de aseo personal, así como la ropa interior, los calcetines y la ropa en general, cada persona debe llevarlos consigo.

Por encima del nivel A, existen los niveles B, que corresponden a personal militar general y viajeros de larga distancia, y el nivel C, que corresponde a personal de reconocimiento y exploradores de campo. En estos dos niveles, además de los uniformes de camuflaje y las chaquetas cortavientos que reemplazan a los uniformes de entrenamiento, se incluyen más equipos especializados para actividades al aire libre y equipos militares profesionales. La variedad es amplia e inagotable. Sin embargo, muchos de estos artículos del nivel B no se distribuyen de forma regular, sino que se proporcionan temporalmente cuando es necesario y deben devolverse después.
...
"Está bien, que los lleven ellos mismos. Así tendremos más repuestos para los componentes de las computadoras", suspiró Shi Kai, quien era responsable de toda la información relacionada con los viajeros temporales. Él también tenía mucha carga de trabajo; un armario lleno de equipos de informática, y con su nivel de estudios universitarios, no estaba seguro de si podría manejarlos.

Wang Luobin y otros, responsables de la adquisición de suministros, se vieron obligados a viajar repetidamente entre ciudades cercanas para comprar una variedad de artículos que no habían previsto, y que solo se dieron cuenta que eran útiles al momento de la partida.

Se completó el trabajo de empaquetado a través de constantes revisiones y complementos. El ruido cesó muy tarde, y a la mañana siguiente, los viajeros temporales se reunieron en el campo de entrenamiento, donde cada uno se puso el uniforme proporcionado.

"No, se parece a una formación militar", observó Xi Yazhou, examinando a los *viajeros temporales* que estaban sentados en el suelo, esperando para embarcar.

"Mmm, una multitud heterogénea", dijo Ma Qian con desgana. La escena que tenía delante, más que parecer un ejército, recordaba a los entrenamientos militares de la época universitaria.

"No digas eso, Lao Ma", dijo Xi Yijian con entusiasmo, dándole una palmada en el hombro. "Todavía tenemos que conquistar toda China juntos..."
