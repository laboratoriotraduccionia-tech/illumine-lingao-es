...
Este conjunto de herramientas fue diseñado por Lin Shenhe, quien dibujó cuidadosamente las dimensiones y la forma de cada una, y luego fueron fabricadas conjuntamente por la fábrica de madera y la fábrica de maquinaria. El primero es un cepillo para cañones, con una base de madera en la que se envuelve lana, que se utiliza para humedecer y extinguir las chispas que quedan en el interior del cañón. El grupo de artillería buscó en la base de datos durante mucho tiempo, pero no encontró ningún registro de existencias de lana, por lo que se utilizó algodón en su lugar. El segundo es un cepillo seco para cañones, similar al anterior, y se utiliza para secar la humedad que queda de los pasos anteriores. Una vara de madera con un gancho de hierro en forma de espiral se utiliza para eliminar cualquier trozo de papel o fibra que pueda quedar en el interior del cañón. En esa época, los cañones europeos ya utilizaban paquetes de pólvora predeterminados, y la pólvora se envolvía en papel o franela. La pieza con la parte superior abultada es una varilla de carga, que se utiliza para introducir la pólvora y el proyectil. Finalmente, hay una varilla de encendido, que era más compleja en la versión original, pero Lin Shenhe la simplificó, utilizando una lanza corta capturada y envolviéndola con una mecha.
...
"Informe, ¿cómo se apunta?", pensó Ying Yu, que ya se había sumergido en el papel de artillero. De repente, se dio cuenta de que sus conocimientos de artillería eran completamente inútiles frente a ese cañón; no tenía ni idea de cómo usar el visor en el cañón, ni cómo calcular los ángulos.

"Usa esto", dijo Lin Shenhe, quien bajó de un coche anterior una pequeña maleta. Esta maleta era completamente diferente a las cajas de madera de alta calidad producidas por la fábrica de procesamiento de madera de Bopu, y a simple vista se podía ver que era un producto de época antigua y de excelente calidad.

"Esto es lo que traje desde Estados Unidos, un auténtico juego de herramientas de medición utilizado por la artillería en el siglo XVIII."

"¿Esto es una vaca?" Las cabezas de los artilleros se agolparon, deseando ver esa antigüedad del siglo XIX.
...
"Esto es una tabla de balística, también conocida como 'tabla de pruebas'. Se refiere a los datos de disparo específicos obtenidos mediante pruebas de tiro que la fábrica realiza antes de que los cañones salgan de la fábrica. Por ejemplo, indica la distancia que puede alcanzar un proyectil en determinadas condiciones, como el uso de munición sólida, con una carga de 1 libra y un ángulo de elevación de 5 grados. Esta tabla incluye datos no solo para munición sólida, sino también para proyectiles de mortero, granadas y proyectiles incendiarios."

"También existen en los cañones modernos", recordó Ying Yu, recordando las tablas de disparo que había utilizado en el cañón de 130 milímetros.

"Es correcto, el concepto de tablas de tiro en las armas de fuego modernas se originó así. Sin embargo, un estadounidense con quien luché en el pasado me dijo que esta tecnología se originó mucho antes, en el siglo XVI."

"La expresión 'dǎ pào' provocó sonrisas lascivas en los rostros de algunas personas."

"Con el indicador de disparo, los artilleros, simplemente estimando la distancia, pueden saber a qué ángulo deben ajustar el cañón". Lin Shenhe tomó de nuevo una placa de cobre con líneas.

"Esto es una regla, es un instrumento de medición de alcance de artillería de la época", explicó. Describió el principio de funcionamiento y el método de uso. Era una herramienta matemática sencilla que utilizaba el principio de triángulos semejantes para calcular la distancia, y por supuesto, no era nada del otro mundo para los viajeros temporales que habían recibido una educación moderna completa.

"Sin embargo, ¿tiene sentido esto?", preguntó Zhang Berlin, con cierta duda. "Todos tenemos telescopios, y con un telescopio podemos calcular la distancia aproximadamente. Además, existen instrumentos especializados para ello."

"Para formar una unidad de artillería indígena, esto les vendría muy bien. Es fácil de fabricar y no es difícil de usar. Si se pierde, no importa mucho."

"Esto es un 'chongchi', en realidad es una regla especial, utilizada para medir la cantidad de pólvora". Lin Shenhe sacó otra regla de bronce.
...
China inventó la pólvora y los cañones, pero no inventó la artillería. Esta extraña contradicción incomodaba a todos.
...
"De acuerdo, paquete número dos."

6 libras de munición de hierro rodaron dentro de la boca del cañón, y por el sonido, no parecía haber ninguna obstrucción. Zhang Bailin, con cuidado, utilizó la varilla de carga para asegurar firmemente la munición; esto requiere cierta habilidad, ya que no se puede comprimir demasiado, de lo contrario, podría causar una combustión incompleta y no explotar.

Lin Shenhe inmediatamente utilizó una broca de hierro para introducirla desde el orificio de encendido, perforando el paquete de pólvora y luego llenando el orificio de encendido con fuego.
...
Con un grito de Lin Shenhe, Ying Yu, quien estaba a cargo de encender el mecanismo, sopló la mecha enrollada en la culata de la pistola de hierro, acercándola a la chispa. Su corazón latía con fuerza; incluso en su primer entrenamiento con armas reales después de ingresar a la unidad militar, no había estado tan nervioso.

La mecha en la boca del cañón chispeó y encendió, expulsando chispas de aproximadamente medio centímetro de longitud, acompañadas de un siseo. En un instante, el cañón retrocedió violentamente, expulsando una densa nube de humo blanco y fuego, mientras un estruendoso rugido resonaba y un proyectil oscuro salía disparado.

"¡Banzai!", exclamaron los marineros.

"¡Colaboracionista! Absolutamente un colaboracionista", murmuró Zhang Berlin.

Un proyectil de hierro, arrastrando una nube de humo, voló más de cuatrocientos metros y cayó pesadamente al suelo, levantando una nube de tierra mezclada con los restos incandescentes de la explosión.
...
Ying Yu también corrió hacia allí, con el rostro cubierto de hollín: "¿Los cañones están en orden?"

"No te preocupes, es muy resistente."

"Vamos, vamos a ver la situación de los proyectiles."
